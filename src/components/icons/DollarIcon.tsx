export const DollarIcon = (props: any) => (
  ...
  >
    ...
    >
      <path d="M 378.255 373.391 c -6.01 24.107 -30.427 38.778 -54.537 32.767 c -24.1 -6.01 -38.771 -30.428 -32.758 -54.534 c 6.007 -24.11 30.424 -38.783 54.527 -32.772 C 369.596 324.862 384.266 349.282 378.255 373.391 L 378.255 373.391 z" 
      style={{
        stroke: "none",
        strokeWidth: 1,
        strokeDasharray: "none",
      ...
      transform=" matrix(1 0 0 1 -289.60744 -317.50471) " 
      strokeLinecap="round"/>
